...
def config_parser(cmd=None):
    ...
    parser.add_argument("--datadir", type=str, default='C:\\Users\\cindyhung\\Documents\\semantic_mvs-nerf5\\data\\scans',
    ...
    # semantic
    parser.add_argument("--enable_semantic",action="store_true",
                        help='whether to enable semantic')
